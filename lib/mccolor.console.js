(function() {
  ...
  xtColors = [0, 19, 34, 37, 124, 127, 214, 145,
    59, 63, 83, 87, 203, 207, 227, 15],
  defaultEscaper = "\u00A7";
  
  var mccolor = function(options) {
    var escaper = defaultEscaper,
    outputNonEscapedChar = true,
    outputEscaper = false,
    cleanUp = false,
    content = "",
    color = 15, bold, italic, underline, strike, obf,
    escaped, styleChanged, style, buf = [], ret = "", 
